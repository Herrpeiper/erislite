...
# Description:
#  This module provides a user-friendly interface to view and analyse
#  the logs generated by the Threat Sweep module. Users can see recent
#  sweeps, view detailed reports, and understand the risk scores and tags
#  associated with each sweep. This helps in quickly assessing the security
#  posture of the system and identifying areas that may require attention.
