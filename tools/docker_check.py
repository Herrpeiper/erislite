...
# Description:
#   This module performs a security check on running Docker containers, looking for common misconfigurations that 
#   could lead to vulnerabilities. It checks for privileged mode, risky mounts, and exposed Docker sockets. The 
#   results are displayed in an interactive table format using the Rich library, and can also be returned as 
#   structured data for integration with other tools or reports.
